...
;; #t
(define (dir? x)
  (or (or (equal? x "up") (equal? x "down")) (or (equal? x "right") (equal? x "left")))) 
...
(define (opposite-dir? d1 d2)
  (or (or (and (equal? d1 "up") (equal? d2 "down")) (and (equal? d1 "down") (equal? d2 "up")))
  (or (and (equal? d1 "right") (equal? d2 "left")) (and (equal? d1 "left") (equal? d2 "right")))))
